---
name: testing
description: Test structure, mocking patterns, coverage requirements, testing frameworks for components and utilities
---
...
const handlers = [trpcMsw.activities.list.query(() => [mockActivity])];
