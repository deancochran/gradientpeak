...
6. finalize tooling move
7. finalize cutover and cleanup gates

## Parallelizable Work

- DB design and auth design can progress in parallel after the package map and inventories exist
- web route mapping and tooling migration planning can progress in parallel once the core package map is stable
