...
- [x] **Task 2.3:** Implement Normalized Speed for all activities.
  - File: `packages/core/calculations/normalized-speed.ts`
  - Implement `calculateNormalizedSpeed` (Total Distance / Moving Time).
- [x] **Task 2.4:** Implement Efficiency Factor & Aerobic Decoupling.
...
- [x] **Task 2.8:** Implement LTHR Detection.
...
- [x] **Task 3.1:** Update `packages/core/schemas/activity_payload.ts`.
...
- [x] **Task 4.1:** Implement Weather API integration.
