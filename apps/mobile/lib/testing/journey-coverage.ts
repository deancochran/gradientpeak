...
export const mobileJourneyCoverageManifest = {
  "auth.sign_in": {
    evidence: [
      ...
      {
        kind: "runtime_flow",
        path: ".maestro/flows/smoke/auth_navigation.yaml",
        status: "validated",
        verificationStatus: "syntax_checked",
      },
    ],
    runtimeVerificationStatus: "syntax_checked",
    selectors: {
  ...
  "account.onboarding": {
    ...
    runtimeVerificationStatus: "declared",
    selectors: {
      authenticatedTab: "tab-button-plan",
  ...
  "record.quick_start": {
    evidence: [
      ...
      {
        kind: "runtime_flow",
        path: ".maestro/flows/smoke/record_lifecycle.yaml",
        status: "validated",
        verificationStatus: "syntax_checked",
      },
      {
