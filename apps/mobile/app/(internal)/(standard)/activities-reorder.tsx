      ...
      {showDiscardConfirm ? (
        <AppConfirmModal
          ...
          primaryAction={{
            ...
            onPress: () => router.back(),
            variant: "destructive",
            testID: "activities-reorder-discard-confirm",
          }}
          secondaryAction={{
            label: "Keep Editing",
          ...
          testID="activities-reorder-discard-modal"
      ...
      {statusModal ? (
        <AppConfirmModal
          ...
          primaryAction={{
            ...
            testID: "activities-reorder-status-confirm",
          }}
          testID="activities-reorder-status-modal"
