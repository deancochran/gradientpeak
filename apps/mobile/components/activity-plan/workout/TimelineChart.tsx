...
export function TimelineChart({
  ...
  const totalGapWidth = useMemo(() => {
    ...
    return width;
  }, [flattenedSteps, gapBetweenIntervals, gapWithinInterval]);
  ...
  }, [chartData, gapBetweenIntervals, gapWithinInterval]);
  ...
  const _maxAxisXMinutes = Math.max(0, Math.round(totalDuration / 60000));
