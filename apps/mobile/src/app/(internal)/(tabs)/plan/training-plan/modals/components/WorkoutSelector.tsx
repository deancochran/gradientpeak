// apps/mobile/src/app/(internal)/(tabs)/plan/training-plan/modals/components/WorkoutSelector.tsx
      ...
      >
        <View className="flex-row items-start">
          ...
          <View className="mr-3 items-center justify-center w-10 h-10 rounded-full bg-gray-100">
            <Text className="text-2xl">{getActivityTypeIcon(item.activity_type)}</Text>
          </View>

          {/* Workout Details */}
          <View className="flex-1">
            <Text className={`font-semibold text-base ${isSelected ? "text-blue-700" : "text-gray-900"}`}>
              {item.name}
            </Text>
