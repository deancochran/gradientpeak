...
export interface ActiveWorkout {
  ...
  plannedActivityId?: string; // Reference to a planned activity
...
export const useWorkoutStore = create<WorkoutState>()(
  persist(
    (set, get) => ({
      ...
      startWorkout: async (
        ...
        try {
          ...
          console.error("Activity Store: Failed to start activity:", error);
          throw error;
        }
      },
      ...
      pauseWorkout: async () => {
        ...
        try {
          ...
          console.error("Activity Store: Failed to pause activity:", error);
          throw error;
        }
      },
      ...
      resumeWorkout: async () => {
        ...
        try {
          ...
          console.error("Activity Store: Failed to resume activity:", error);
          throw error;
        }
      },
      ...
      stopWorkout: async () => {
        ...
        try {
          ...
          console.error("Activity Store: Failed to stop activity:", error);
          throw error;
        }
      },
      ...
      completeWorkout: async () => {
        ...
        try {
          ...
          console.error("Activity Store: Failed to complete activity:", error);
          throw error;
        }
      },
      ...
      recoverWorkout: async () => {
        try {
          ...
          console.error(
            "❌ Activity Store: Failed to recover activity:",
            error,
          );
        }
      },
    ...
    {
      name: "turbofit-activity-store",
      storage: createJSONStorage(() => AsyncStorage),
      partialize: (state) => ({
        // Persist activity settings and some state
