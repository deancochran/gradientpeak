import { getUserFromHeaders, handleApiError, NotFoundError, successResponse, UnauthorizedError, validateRequest } from '@/lib/api-utils'
import { db } from '@/lib/db'
import { deleteActivity, getActivityById } from '@repo/drizzle/queries'
...
const UpdateActivitySchema = z.object({
  ...
  syncStatus: z.enum(['local_only', 'syncing', 'synced', 'sync_failed']).optional(),
