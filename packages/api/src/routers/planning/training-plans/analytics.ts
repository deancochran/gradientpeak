...
export const trainingPlansAnalyticsRouter = createTRPCRouter({
  ...
  getIntensityDistribution: trainingPlansBaseRouter._def.procedures.getIntensityDistribution,
  getIntensityTrends: trainingPlansBaseRouter._def.procedures.getIntensityTrends,
  checkHardActivitySpacing: trainingPlansBaseRouter._def.procedures.checkHardActivitySpacing,
