...
const FTMS_TRAINING_STATUS_LABELS: Record<number, string> = {
  ...
  0x08: "fitness_test",
  0x09: "speed_outside_control_region_low",
  0x0a: "speed_outside_control_region_high",
  0x0b: "cool_down",
  0x0c: "watt_control",
  0x0d: "manual_mode",
  0x0e: "pre_workout",
...
const FTMS_MACHINE_STATUS_LABELS: Record<number, string> = {
  0x00: "reset",
  0x01: "stopped_or_paused_by_user",
  0x02: "stopped_by_safety_key",
  0x03: "started_or_resumed_by_user",
  0x04: "target_speed_changed",
  0x05: "target_inclination_changed",
  0x06: "target_resistance_changed",
  0x07: "target_power_changed",
  0x08: "target_heart_rate_changed",
  0x13: "spin_down_status",
  0x14: "target_cadence_changed",
};
