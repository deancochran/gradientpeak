...
CREATE TABLE IF NOT EXISTS "public"."activities" (
    ...
    "sync_status" "public"."sync_status" DEFAULT 'local_only'::"public"."sync_status" NOT NULL,
...
CREATE POLICY "Service role can do everything" ON "public"."profiles" USING (("current_setting"('role'::"text") = 'service_role'::"text"));
